...
- **Decision Slots**: Claim questions for oracle-free resolution
...
|----------|-------------|
| [macOS Installation](docs/INSTALL_MACOS.md) | Install, run, and test on macOS |
| [Linux Installation](docs/INSTALL_LINUX.md) | Install, run, and test on Linux |
| [Windows Installation](docs/INSTALL_WINDOWS.md) | Install, run, and test on Windows |
