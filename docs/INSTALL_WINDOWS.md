...
```powershell
.\target\debug\truthcoin_dc_app_cli.exe --rpc-port 18332 slot-claim `
...
```powershell
.\target\debug\truthcoin_dc_app_cli.exe --rpc-port 18332 slot-list --period 0 --status claimed
```
...
.\target\debug\truthcoin_dc_app_cli.exe --rpc-port 18332 slot-claim-category `
